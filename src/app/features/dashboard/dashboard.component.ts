      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="flex items-baseline">
            <p class="text-4xl font-bold text-primary">{{ organizationsCount }}</p>
        ...
        >
          ...
          <div class="flex items-baseline">
            <p class="text-4xl font-bold text-primary">{{ pendingDeclarations }}</p>
        ...
        >
          ...
          <div class="flex items-baseline">
            <p class="text-4xl font-bold text-primary">{{ pendingAllocations }}</p>
            <p class="ml-2 text-gray-600">pending</p>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-baseline">
            <p class="text-4xl font-bold text-primary">{{ pendingNominations }}</p>
            <p class="ml-2 text-gray-600">pending</p>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-baseline">
            <p class="text-4xl font-bold text-primary">{{ pendingContracts }}</p>
            <p class="ml-2 text-gray-600">pending</p>
          </div>
        </div>
